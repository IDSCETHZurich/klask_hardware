...
private:
     ...
     */
    rclcpp_action::CancelResponse handle_cancel(const std::shared_ptr<GoalHandleHomePeg> goal_handle);
     ...
     */
    float calculate_distance(const geometry_msgs::msg::Point& p1, const geometry_msgs::msg::Point& p2) const;
